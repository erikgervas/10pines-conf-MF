...
// Function to import the webpck hot development client in development environment
const withHotDevClient = (...sources) => [ require.resolve('inferno-dev-utils/webpackHotDevClient'), ...sources ];
...
module.exports = {
  ...
  entry: {
    'let-the-hell-break-loose': withHotDevClient('./src/singleSpaEntry.js'),
    index: withHotDevClient('./src/index.js'),
  },
  output: {
    library: 'status',
    libraryTarget: 'umd',
