...
(def salas [{:nombre "Norte" :color "#d8d3cc" :reserva "No tiene reservas hasta las 18hs"}
            {:nombre "Sur" :color "#e6e3e3" :reserva "[16hs-17hs] Retro supervillanos"}
            {:nombre "Roja" :color "#fddfdf" :reserva "[16hs-17hs] Inglés upper2"}
